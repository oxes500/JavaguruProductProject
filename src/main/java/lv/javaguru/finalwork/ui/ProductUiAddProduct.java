...
import lv.javaguru.finalwork.businesslogic.services.AddProdcutServiceToCreatedListService;
...
public class ProductUiAddProduct {
    ...
    private AddProdcutServiceToCreatedListService prodcutServiceToCreatedListService;

    @Autowired
    public ProductUiAddProduct(AddProductService productService, AddProdcutServiceToCreatedListService prodcutServiceToCreatedListService) {
    ...
    public void addProduct() {
        try {
            ...
            System.out.println("2  Add product in existing list");
            ...
            switch (userChoice) {
                ...
                case "2": {
                    ...
                    AddProductResponse response = prodcutServiceToCreatedListService.addProduct(product, productList);
                    if (response.isSuccess()) {
                        System.out.println("Product successfully added in the list!");
                    } else {
                        System.out.println("Operation failed!");
